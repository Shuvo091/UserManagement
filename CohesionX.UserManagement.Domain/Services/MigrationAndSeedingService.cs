// <copyright file="MigrationAndSeedingService.cs" company="PlaceholderCompany">
// Copyright (c) PlaceholderCompany. All rights reserved.
// </copyright>

using CohesionX.UserManagement.Database.Abstractions.Options;
using CohesionX.UserManagement.Database.Seeding;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Options;

namespace CohesionX.UserManagement.Database.Services;
...
public class MigrationAndSeedingService : IHostedService
{
    ...
    private readonly IOptions<DbSeederOptions> dbSeederOptions;
    ...
    public MigrationAndSeedingService(IServiceProvider serviceProvider, IOptions<DbSeederOptions> dbSeederOptions)
    {
        ...
        this.dbSeederOptions = dbSeederOptions;
    }
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var seedFilePath = this.dbSeederOptions.Value.SeedFilePath;
